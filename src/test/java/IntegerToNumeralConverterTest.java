...
public class IntegerToNumeralConverterTest {
    ...
    public void rejectsNumbersGreaterThan3999() {
        assertThat(converter.convert(4000)).isEqualTo("Invalid result");
        assertThat(converter.convert(9999)).isEqualTo("Invalid result");
    }

    @Test
    public void rejectsNumbersLessThan1() {
        assertThat(converter.convert(0)).isEqualTo("Invalid result");
        assertThat(converter.convert(-1)).isEqualTo("Invalid result");
    }
}